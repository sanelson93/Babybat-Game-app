const CACHE='nocturnal-games-v320';
const CORE=['./','./index.html','./styles.css?v=3.2.0','./config.js?v=3.2.0','./app.js?v=3.2.0','./manifest.json?v=3.2.0'];
...
// v3.2.0 — Web Push delivery for installed Nocturnal Games PWAs.
