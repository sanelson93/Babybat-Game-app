const CACHE='nocturnal-games-v319';
const CORE=['./','./index.html','./styles.css?v=3.1.9','./config.js?v=3.1.9','./app.js?v=3.1.9','./manifest.json?v=3.1.9'];
...
// v3.1.9 — Web Push delivery for installed Nocturnal Games PWAs.
